...
blockHash = web3.eth.contract(abi=contract_abi, bytecode=contract_bytecode)
# este es el que deploya desde acc0
bh_txn = blockHash.constructor().buildTransaction(transaction=txargs0)

signed_txn = web3.eth.account.signTransaction(bh_txn, private_key=private_key0)
...
print("Deployment address:", blockHash.address)
