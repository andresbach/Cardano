...
with open("../Contratos/Tests/Compilado/Cardano2.abi") as contract_abi_file:
  contract_abi = json.load(contract_abi_file)
with open("../Contratos/Tests/Compilado/Cardano2.bin") as contract_bin_file:
  contract_bytecode = '0x' + contract_bin_file.read()

# este solo construye la instancia, pero no deploya
card2 = web3.eth.contract(abi=contract_abi, bytecode=contract_bytecode)
# este es el que deploya desde acc0
cardano2_txn = card2.constructor().buildTransaction(transaction=txargs0)

signed_txn = web3.eth.account.signTransaction(cardano2_txn, private_key=private_key0)
...
print("Deployment address:", card2.address)
