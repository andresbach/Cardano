...
# exec(open("../Setups/setupcardano.py").read())
...
flip = web3.eth.contract(abi=contract_abi, bytecode=contract_bytecode)
# este es el que deploya desde acc0
flip_txn = flip.constructor().buildTransaction(transaction=txargs0)

signed_txn = web3.eth.account.signTransaction(flip_txn, private_key=private_key0)
...
print("Deployment address:", flip.address)
